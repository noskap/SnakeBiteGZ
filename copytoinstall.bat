...
REM xcopy /y %targetDir%MakeBiteGZ.exe %solutionDir%installerbuild\ - done from makebites solution
REM xcopy /y %targetDir%MakeBiteGZ.exe.config %solutionDir%installerbuild\ - done from makebites solution
